...
Race.create(name: "Droid", agility: 1, brawn: 1, intellect: 1, presence: 1, willpower: 1, cunning: 1, wounds_thresh: 10, strain_thresh: 10, xp: 175, bonus: "None", avatar: "/images/avatars/droid.jpg", description: "Droids get a Bonus Skill: Specialization")
Race.create(name: "Gand", agility: 2, brawn: 2, intellect: 1, presence: 2, willpower: 3, cunning: 2, wounds_thresh: 10, strain_thresh: 10, xp: 100, bonus: "Discipline", avatar: "/images/avatars/gand.jpg", description: "Gands get a Bonus Skill: Discipline")
Race.create(name: "Human", agility: 2, brawn: 2, intellect: 2, presence: 2, willpower: 2, cunning: 2, wounds_thresh: 10, strain_thresh: 10, xp: 110, bonus: "Specialty", avatar: "/images/avatars/human.jpg", description: "Humans get a Bonus Specialty")
Race.create(name: "Rodian", agility: 3, brawn: 2, intellect: 2, presence: 2, willpower: 1, cunning: 2, wounds_thresh: 10, strain_thresh: 10, xp: 100, bonus: "Survival", avatar: "/images/avatars/rodian.jpg", description: "Rodians get a Bonus Skill: Survival")
Race.create(name: "Trandoshan", agility: 1, brawn: 3, intellect: 2, presence: 2, willpower: 2, cunning: 2, wounds_thresh: 12, strain_thresh: 9, xp: 90, bonus: "Perception", avatar: "/images/avatars/trandoshan.jpg", description: "trandoshans get a Bonus Skill: Perception")
Race.create(name: "Twi'lek", agility: 2, brawn: 1, intellect: 2, presence: 3, willpower: 2, cunning: 2, wounds_thresh: 10, strain_thresh: 11, xp: 100, bonus: "Charm", avatar: "/images/avatars/twilek.jpg", description: "Twi'leks get a Bonus Skill: Charm")
...
Race.create(name: "Wookiee", agility: 2, brawn: 3, intellect: 2, presence: 2, willpower: 1, cunning: 2, wounds_thresh: 14, strain_thresh: 8, xp: 90, bonus: "Brawl", avatar: "images/avatars/wookiee.jpg", description: "Wookiees get a Bonus Skill: Brawl")
